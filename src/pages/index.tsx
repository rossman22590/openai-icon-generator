        ...
        <form action="/send-data-here" method="post" className="flex flex-col items-center">
          ...
          {outputResults && 
            <>
              ...
              <img id="scream" className='hidden' src={imgSrc} alt="test"></img>

              <canvas id="myCanvas" width="200" height="100" className={`mt-12 container rounded-lg flex justify-center items-center w-16 h-16 ${backgroundColor}`}></canvas>
